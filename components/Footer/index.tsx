...
export const Footer = () => {
  const panelLinks =
    'text-sm text-slate-600 dark:text-slate-400 dark:hover:text-gray-100 hover:text-secondary';
  const gridLinks =
    'block mb-3 text-slate-600 dark:text-slate-400 dark:hover:text-gray-100 hover:text-secondary';
  const logoLinks =
    'flex items-center space-x-2 text-slate-600 dark:text-slate-400 dark:hover:text-gray-100 hover:text-secondary';

  // get year for copyright
  const year = new Date().getFullYear();

  return (
    <div className='flex items-center justify-center w-full px-4 bg-white dark:bg-accent md:pt-24 border-t dark:border-gray-800 border-gray-200'>
          ...
          */}
          <div className='flex flex-col items-start ml-8'>
            <Link
              ...
              className='flex text-accent hover:text-secondary dark:text-gray-300'
              href='/'
            >
              <Image
            ...
            <ul className='flex items-start justify-center mt-8 space-x-4 text-sm md:flex-col md:space-x-0 md:space-y-3 '>
              ...
              <li>
                <a className={logoLinks} target='_blank' href=''>
                  <span className='inline-block '>
                    <svg
                      aria-hidden='true'
                      focusable='false'
          ...
          <div className='flex flex-col space-y-6 md:space-y-0'>
            ...
            */}
            ...
            <p className='text-sm text-gray-600 dark:text-gray-300'>
              Copyright © {year} Hikmat - HubSpot & WordPress Expert.
