...
export default function Accounts() {
  return (
    <section className="bg-white dark:bg-[#17191c]">
    <div className="grid sxl:px-4 sxl:pt-2  px-16 pt-8 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-10">
        <div className="mr-auto place-self-center lg:col-span-7">
            ...
            <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">This
               Building a digital product is hard. {"I've"} been there. {"We'll"} help you with strategy, design, and
                development.</p> 

            <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">

                <Link href="https://github.com/hikmat12345" target="_blank"
                    className="inline-flex items-center bg-gradient-to-r from-purple-600 to-blue-600     hover:bg-purple-300  justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                ...
                <Link href="https://behance.net/hikikhan" target="_blank"
        ...
        <div className="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <Image width={500} height={500} className='w-full' src="https://demo.themesberg.com/landwind/images/hero.png" alt="hero image"/>
        </div>
