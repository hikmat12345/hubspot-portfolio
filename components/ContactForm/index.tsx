...
const ContactForm = () => {
  return (
    <>
      <section className="bg-white px-5 dark:bg-transparent py-20 lg:py-[120px] overflow-hidden relative z-10">
        <div className="px-10">
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed mb-9 text-body-color">
                  As a one-person army, I am both the frontend and backend developer.
                  <br />
                  I craft visually engaging user interfaces and build the powerful engine that drives websites and applications.
                  <br />
                  {"It's"} a dynamic role that demands creativity, technical prowess, and the ability to wear many hats, all to create seamless digital experiences.
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <Link className="text-base text-body-color" href="https://goo.gl/maps/6Y5YQ9Z3Z7Q2" target="_blank">
                      Sector G-13 , Islamabad, Pakistan
                    </Link>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <Link className="text-base text-body-color" href="tel:+923429349015">
                      {"(+92)"}342 9349015
                    </Link>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <Link className="text-base text-body-color" href={`mailto:hikmatullahit@gmail.com`}>
                      hikmatullahit@gmail.com
                    </Link>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-white dark:bg-transparent rounded-lg shadow-lg sm:p-12">
                <form>
                  <ContactInputBox
                    type="text"
                    name="name"
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full p-3 text-black dark:text-white transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
