...
//   statusPage: process.env.BASE_URL ?? '',
// };

// Our basic SEO data
export const meta: Meta = {
  URL: 'https://hikmatdev.vercel.app/',
  siteName: 'Hikmat Web Developer',
  title: 'I am Senior Software Engineer and I love to build things on internet',
    description:
    // 'We are a team of dreamers, creators, and builders on a mission to unlock the potential of your dreams using Latest technologies',
    'I am a dreamer, creator, and builder on a mission to unlock the potential of your dreams using Latest technologies',
  themeColor: '##F5E1E6',
