...
//   const res = await fetch(`${env.BASE_URL}/tutorial?id=${slug}`,  { 
//     method: 'GET',
...
//   const getSlug = searchParams.id;
//   console.log(searchParams, 'props')

//    const result = await fetchData(getSlug);
//    console.log(result, 'result post')
//   const { id, category, title, tages, views, Author, detail, message } =Array.isArray(result.data) ? result.data[0]: result.data
...
//           </a>
//           {/* / <!--post categories--> */} 
//           {Array.isArray(tages) && tages.length > 0 && (
...
//                 3000
//               </p>
//               {views && <p className='text-sm text-gray-400 font-bold ml-5'>Views {views}</p>}
//             </div> */}
//             {/* / <!--author avator--> */}
            
//           </div>
//           {/* <!--post content--> */}
//           <div className='  px-10  mx-auto text-2xl text-gray-700 mt-4 rounded bg-gray-100'>
//             {/* <!--content body--> */}
//             <div>
//               <p className='mt-2 p-0'>{detail}</p>
//             </div>
//           </div>
//           {Author && (
...
//                   <a href='#_'>Oauth using facebook with flask,mysql,vuejs and tailwind css</a>
//                 </h2>
...
//                 </div>
//                 <h2 className='text-base text-gray-500 font-bold sm:text-lg md:text-xl'>
//                   <a href='#_'>Authenticating users with email verification in Django apps</a>
//                 </h2>
...
//                 </div>
//                 <h2 className='text-base text-gray-500 font-bold sm:text-lg md:text-xl'>
//                   <a href='#_'>Creating user registration and authentication system in flask</a>
//                 </h2>
...
//               {/* <img src="https://avatars.githubusercontent.com/u/71964085?v=4" alt="avatar" className="hidden object-cover w-14 h-14 mx-4 rounded-full sm:block"> */}
//             </a>
//             <div>
...
//                 Please help with how you did the migrations for the blog database fields.I tried
//                 mine using exactly what you instructed but its not working!!.
//               </p>
//             </div>
//           </div>
//           {/* / <!--comment 2--> */}
...
//               <p className='text-sm font-bold text-gray-300'>August 22,2021</p>
//               <p className='mt-2 text-base text-gray-600 sm:text-lg md:text-normal'>
//                 Especially I dont understand the concepts of multiple models.What really is the
//                 difference between the blog model and blogApp model? Am stuck
//               </p>
//             </div>
//           </div>
//         </div>
