...
//   const res = await fetch(`https://${env.BASE_URL}.statuspage.io/api/v2/summary.json`, {
//     next: { revalidate: 30 },
//   });
//   return res.json();
// }
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang='en'>
      <Head>
         <link rel="shortcut icon" href="/img/site-logo.png" type="image/svg+xml"/>
      </Head>
      <body
        className={`${inter.variable}  bg-white font-sans antialiased transition-colors dark:bg-[#17191c]`}
      >
        <>
{/*           <Suspense>
            <GoogleTagMgr />
